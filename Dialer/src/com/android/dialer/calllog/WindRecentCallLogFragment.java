...
public class WindRecentCallLogFragment extends ListFragment implements
        CallLogQueryHandler.Listener, CallLogAdapter.CallFetcher {
    private static final String TAG = "RecentCallLogFragment";

    public static final String RECENT_CALL_LOG_TAG = "recent_call_log_tag";

    private WindRecentCallLogAdapter mAdapter;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new WindRecentCallLogAdapter(getActivity(), this,
    ...
    private void customizeActionBar() {
        ...
        View customView = inflater.inflate(R.layout.wind_recent_call_log_action_bar, null);
        ...
        mAddBtn = (Button) customView.findViewById(R.id.add_call_log);
        mAddBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ArrayList<Integer> list = getSelectedGroupCallIdList();
                HashMap<String, String> callLogMap = getSelectedCallLogInfoList();
                log("mAddBtn clicked,SelectedGroupCallIdList:" + list);
                log("mAddBtn clicked,SelectedCallLogInfoList size:" + callLogMap.size());
                if (callLogMap.size() > 0) {
        ...
        if(getSelectedGroupCallIdList().size() > 0)
        {
...
//        }
    ...
    {
       return mAdapter.getSelectedCallLogIds();
    }

    public ArrayList<Integer> getSelectedGroupCallIdList() {
        return mAdapter.getSelectedGroupCallIdList();
    }

    public HashMap<String, String> getSelectedCallLogInfoList()
    {
        return mAdapter.getSelectedCallLogInfoList();
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (null != checkBox) {
            ...
            ((WindRecentCallLogActivity) getActivity()).updateSelectedItemsView(mAdapter
    ...
    */
    ...
    private WindRecentCallLogAdapter.SelectedItemChangeListener mSelectedItemChangeListener =
            new WindRecentCallLogAdapter.SelectedItemChangeListener() {
                @Override
                public void onSelectedItemCountChange(int count) {
                    if (getActivity() != null) {
                        ((WindRecentCallLogActivity) getActivity()).updateSelectedItemsView(count);
                    }
                }
            };
    /** @} */
