...
public class DialerUtils {
    ...
    public static void loadThumbnail(ImageView view, long photoId)  {
    	if (photoId == 0) {
    		ContactsUtils.loadThumbnail(view,photoId);
    	} else {
    		view.setImageResource(R.drawable.asus_contacts_dialer_down);
    	}
    }
    //D: huangyouzhong@wind-mobi.com 20160310 for Dialer UI feature -e
    // pengfugen@wind-mobi.com 2016/03/10 start
    public static void loadThumbnail(ImageView view, long photoId, int numberType)  {
        if(numberType == ContactsUtils.TYPE_NORMAL)
        {
            view.setImageResource(R.drawable.asus_contacts_ep_phone_default_pic_group1_n);
        } else if(numberType == ContactsUtils.TYPE_NO_NAME)
        {
            view.setImageResource(R.drawable.asus_contacts_ep_phone_default_add_n);
        } else if(numberType == ContactsUtils.TYPE_SIM1)
        {
            view.setImageResource(R.drawable.asus_contacts_ep_phone_default_sim_one_list_n);
        } else if(numberType == ContactsUtils.TYPE_SIM2)
        {
            view.setImageResource(R.drawable.asus_contacts_ep_phone_default_sim_two_list_n);
        }
    }
    // pengfugen@wind-mobi.com 2016/03/10 end
}
