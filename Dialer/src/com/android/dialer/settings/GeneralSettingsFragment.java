...
/* zhangheting@wind-mobi.com 20150925 add for bug 85354 begin */
import com.mediatek.audioprofile.AudioProfileManager.Scenario;
/* zhangheting@wind-mobi.com 20150925 add for bug 85354 end */
...
public class GeneralSettingsFragment extends PreferenceFragment
    ...
    private void setVibrateOnRing(boolean vibrate) {
        if (DialerFeatureOptions.isMTKAudioProfileEnabled()) {
            ...
            String profileKey = audioProfileMgr.getActiveProfileKey();
            /* zhangheting@wind-mobi.com 20150925 add for bug 85354 begin */
            if(audioProfileMgr.getScenario(profileKey).equals(Scenario.SILENT)){
                audioProfileMgr.setActiveProfile(AudioProfileManager.PROFILE_PREFIX + 
			               Scenario.MEETING.toString().toLowerCase());
                profileKey = audioProfileMgr.getActiveProfileKey();
            }	
            /* zhangheting@wind-mobi.com 20150925 add for bug 85354 end */		
