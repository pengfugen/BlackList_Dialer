...
public class DialerFeatureOptions {
    ...
    // add for the menu of IPDIAL
    public static final boolean WIND_IPDIAL_MENU = SystemProperties.get("ro.wind.ipdial.menu").equals("1");
    // xiezeyang@wind-mobi.com 20150723 add end
    /*xulinchao@wind-mobi.com 20150805 start*/
    public static final boolean MTK_C2K_SUPPORT = SystemProperties.get("ro.mtk_c2k_support").equals("1");
    /*xulinchao@wind-mobi.com 20150805 end*/
    //lianbaowei@wind-mobi.com 20150819 start
    public static final boolean WIND_DEF_PRO_E169F = SystemProperties.get("ro.wind.def.pro.e169f").equals("1");
    //lianbaowei@wind-mobi.com 20150819 end
    /* lifeifei@wind-mobi.com 20150825 for #78920 start */
    public static final boolean WIND_DEF_OPTR_E169F_TW = SystemProperties.get("ro.wind.def.optr.e169f.tw").equals("1");
    /* lifeifei@wind-mobi.com 20150825 for #78920 end */
    //yanshuai@wind-mobi.com 20150923 start
    public static final boolean WIND_DEF_OPTR_E169F_NOS = SystemProperties.get("ro.wind.def.optr.e169f.nos").equals("1");
    //yanshuai@wind-mobi.com 20150923 END
    //zhangyanbin@wind-mobi.com add 20160302 for blackList start
    public static final boolean WIND_CALL_BLACK_LIST = SystemProperties.get("ro.wind.call.black.list").equals("1");
