...
final class PstnIncomingCallNotifier {
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            //zhangyanbin@wind-mobi.com add 20160302 for blackList start
            if (WIND_CALL_BLACK_LIST && ExtensionManager.getIncomingCallExt().handlePhoneEvent(msg, mPhoneProxy)) {
                return;
            }
            //zhangyanbin@wind-mobi.com add 20160302 for blackList end
            switch(msg.what) {
                ...
                case EVENT_VOICE_CALL_INCOMING_INDICATION:
                    ...
                    TelephonyConnectionServiceUtil.getInstance()
                            .setIncomingCallIndicationResponse((GSMPhone) ((AsyncResult) msg.obj).result);
                    break;
                /// @}
                default:
                    break;
        ...
        if (newPhone != mPhoneBase) {
            ...
            if (newPhone != null) {
                ...
                mPhoneBase.registerForUnknownConnection(mHandler, EVENT_UNKNOWN_CONNECTION,
                        null);
                /// M: CC032: Proprietary incoming call handling @{
                Log.i(this, "onCreate register for EVENT_VOICE_CALL_INCOMING_INDICATION");
    ...
    private void unregisterForNotifications() {
        if (mPhoneBase != null) {
            ...
            /// M: CC032: Proprietary incoming call handling @{
            mPhoneBase.unregisterForVoiceCallIncomingIndication(mHandler);
            /// @}
        }
    }
    ...
    private void handleNewRingingConnection(AsyncResult asyncResult) {
        ...
        if (connection != null) {
            ...
            if (TelephonyConnectionServiceUtil.getInstance()
                .shouldBlockNumber(mPhoneProxy, call, connection)) {
                return;
            }
            /// @}
    ...
    private void sendIncomingCallIntent(Connection connection) {
        ...
        if (connection.getNumberPresentation() == TelecomManager.PRESENTATION_ALLOWED &&
            ...
            boolean isMpty = connection.isMultiparty();
            Log.d(this, "isMpty: " + isMpty);
            extras.putBoolean(TelecomManagerEx.EXTRA_VOLTE_CONF_CALL_INCOMING, isMpty);
            /// @}
        }
